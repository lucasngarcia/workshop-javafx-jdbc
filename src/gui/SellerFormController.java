...
public class SellerFormController implements Initializable{
	...
	private void notifyDataChangeListeners() {
		for (DataChangeListener listener : dataChangeListeners) listener.onDataChanged();
	}
	...
	public void updateFormData() {
		...
		if (entity.getBirthDate() != null) dpBithDate.setValue(LocalDate.ofInstant(entity.getBirthDate().toInstant(), ZoneId.systemDefault()));
	}
	
	private void setErrorMessages(Map<String, String> errors) {
		Set<String> fields = errors.keySet();
		
		if (fields.contains("name")) lbErrorName.setText(errors.get("name"));
	}
}
